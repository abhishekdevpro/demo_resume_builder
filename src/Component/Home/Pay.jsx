...
function PaymentPlans() {
  ...
  // };
    ...
    <div className='  '>
      <section className="bg-gray-200 dark:bg-white/100">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold  rounded-2xl text-blue-800 border p-3"
          ...
          <div className="space-y-4 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            {/* Pricing Card */}
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-blue-900 text-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white"
            //  style={{backgroundColor:"#333456"}}
            >
              ...
              <Link href="/login2" className="mt-2 text-white border bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900  hover:bg-white hover:text-blue-600">Get started for Free</Link>
            </div>
            {/* Pricing Card */}
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-white bg-blue-900 rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white"
            // style={{backgroundColor:"#333456"}}
            >
              ...
              <button
                ...
                className="text-white bg-primary-600 border hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900 hover:bg-white hover:text-blue-600"
