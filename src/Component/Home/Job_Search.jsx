...
function Course(props) {
  const course =[
    ...
    {
        img:{image},title:"Evolution of AI Resume Builders",link:"https://blog.abroadium.com/evolution-of-ai-resume-builders/"
    },
    { img:{image},title:"AI Resume Builders for International Job Seekers",link:"https://blog.abroadium.com/ai-resume-builders-for-international-job-seekers/"},
    { img:{image},title:"The Algorithms Behind the Buzz of AI Resume",link:"https://blog.abroadium.com/the-algorithms-behind-the-buzz-of-ai-resume/"},
    { img:{image},title:"The Future of AI in Talent Acquisition",link:"https://blog.abroadium.com/the-future-of-ai-in-talent-acquisition/"},
    { img:{image},title:"My AI-Written Resume Got Me an Interview!",link:"https://blog.abroadium.com/my-ai-written-resume-got-me-an-interview/"},
    { img:{image},title:"Using AI to Find the Right Skills for Your Resume",link:"https://blog.abroadium.com/using-ai-to-find-the-right-skills-for-your-resume/"},
    { img:{image},title:"5 Ways AI Can Make Your Resume Stand Out",link:"https://blog.abroadium.com/5-ways-ai-can-make-your-resume-stand-out/"},
    { img:{image},title:"AI Resume Builders",link:"https://blog.abroadium.com/ai-resume-builders/"},
    { img:{image},title:"Personal Branding in the Age of AI",link:"https://blog.abroadium.com/personal-branding-in-the-age-of-ai/"},
    { img:{image},title:"Navigating AI-Powered Job Platforms",link:"https://blog.abroadium.com/navigating-ai-powered-job-platforms/"},
    { img:{image},title:"Rise of AI in Resume Writing",link:"https://blog.abroadium.com/rise-of-ai-in-resume-writing/"},
    { img:{image},title:"A Human-AI Collaboration",link:"https://blog.abroadium.com/a-human-ai-collaboration/"},
    { img:{image},title:"AI-Proof Your Resume",link:"https://blog.abroadium.com/3915/"},
    { img:{image},title:"Beating the Applicant Tracking System",link:"https://blog.abroadium.com/beating-the-applicant-tracking-system-ats-gatekeepers/"},
    { img:{image},title:"Mastering AI to Land Your Dream Job",link:"https://blog.abroadium.com/mastering-ai-to-land-your-dream-job/"},
    { img:{image},title:"AI Can Supercharge Your Resume",link:"https://blog.abroadium.com/ai-can-supercharge-your-resume/"},
    // {
